...
##Database
H2 embedded database is used so no further installations are expected
...
POST http://localhost:8080/lunch/rest/profile/restaurants/100003/vote
...
X-Frame-Options: DENY
X-Content-Type-Options: nosniff
Location: http://localhost:8080/lunch/rest/profile/restaurants/100022
Content-Type: application/json;charset=UTF-8
Transfer-Encoding: chunked
Date: Wed, 30 May 2018 17:10:54 GMT

{
  "id": 100022
}

Response code: 201; Time: 86ms; Content length: 13 bytes